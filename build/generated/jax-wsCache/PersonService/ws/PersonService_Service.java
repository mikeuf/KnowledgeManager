 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/BigWS00/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://ws/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BigWS00/PersonService?wsdl");
    ...
    public PersonService getPersonServicePort() {
        return super.getPort(new QName("http://ws/", "PersonServicePort"), PersonService.class);
    }
    ...
    public PersonService getPersonServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "PersonServicePort"), PersonService.class, features);
    }
